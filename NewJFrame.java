...
private void restartGame() {
    ...
    private void initComponents() {
        ...
        jButtonPlayAgain.setBackground(new java.awt.Color(0, 0, 0));
        jButtonPlayAgain.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jButtonQuit.setBackground(new java.awt.Color(0, 0, 0));
        jButtonQuit.setForeground(new java.awt.Color(255, 255, 255));
        jButtonQuit.setText("Quite game");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jButtonPlayAgain, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    return;
            ...
            if (tryGame == 10) {
    // إعادة استخدام المتغير الموجود سابقًا
    secretColors = ""; // إعادة تهيئة النص بدلًا من إعادة تعريفه
    for (int j = 0; j < secret.length; j++) {
        secretColors += (j + 1) + " : " + getColorName(secret[j]) + "\n";
    }

    // عرض رسالة الخسارة مع الألوان الصحيحة
    JOptionPane.showMessageDialog(null, 
        "Game Over!\nThe correct colors were:\n" + secretColors, 
        "Game Over", JOptionPane.WARNING_MESSAGE);

    // إعادة تشغيل اللعبة
    restartGame(); // إعادة تشغيل اللعبة بالكامل
}
...
// Automatically restart the game
 ...
 int choice = JOptionPane.showConfirmDialog(this, 
    ...
    // إذا اختار المستخدم "Yes" سيتم إغلاق اللعبة
